...
const Summer2023KS = () => (
  <>
    ...
    <div className='hero min-h-screen bg-base-200'>
      <div className='hero-content text-center'>
        <div className='max-w-md'>
          ...
          <p className='py-6'>
            금샘미술관은 금정문화회관 내부에 위치해 있으며, 독자적인 기획과 작가
            네트워크를 통해 변화하는 시각적인 흐름을 담아 전시 콘텐츠를
    ...
    <div className='hero min-h-screen' id='detail'>
      <div className='hero-content flex-col space-x-2 lg:flex-row'>
        {
          '  자신만의 언어와 표현법으로 이야기를 펼치고 있는 모든 작가들이 새롭게 준비하고 있는 플랫폼을 통해 작품을 공개할 수 있는 기회를 마련하고자 합니다. 미술관의 높은 문턱과 전시의 기회가 쉽지 않은 숨은 작가들에게 귀중한 발표의 장으로도 활용될 것입니다. 시각언어와 예술이 다양한 만남과 화학적 변화를 이루고 있는 시기에, 온라인 플랫폼을 개방하여 변화와 혁신들을 직접 눈으로 살펴볼 수 있는 계기를 마련하고자 합니다. 제출된 작품 중 기획적으로 선별된 작품들은 공모전의 형식으로 금샘미술관 전시실에서 전시를 가지게 됩니다. 콘텐츠와 지역, 공간과 작가들의 의미 있는 만남이 온라인과 오프 공간에서 동시에 열리게 되는 이번 공모기획에 많은 응모와 지원 바랍니다.'
        }
    ...
    <div className='hero min-h-screen w-full text-white'>
      <div className='hero-content flex-col'>
        <div>
          <p>
            💡 자격 : 자신만의 스토리, 표현형식과 재료를 탐구하는 만 45세 이하의
            모든 작가, 크리에이터, 창작자
          </p>
          ...
          <p>
            - 설치미술, 조각, 독창적 크리쳐 등의 3차원의 입체적 작품 (제출시에는
            이미지)
          </p>
          <p>
          ...
          <p>
            - 평면, 입체, 미디어 작업의 포맷 : 이미지(jpg) 영상(mov.mp4) 사운드
            (wave.mp3)로 제출
          </p>
          <p>
          ...
          <p>
            플랫폼에 올린 작업들은 최소한의 관리자 검토를 거쳐 자격여부를 드리게
            됩니다.
          </p>
          <p>
