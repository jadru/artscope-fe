...
const Editor = ({
  ...
  const CustomDocument = Document.extend({
    content: 'heading block* paragraph+', // allow headings and paragraphs
  });
  ...
  const handleCreateSaveButton = async () => {
    ...
    try {
      ...
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore
      newState.dto.title = JSONContent.content[0].content.reduce(
  ...
  return (
    <>
      ...
      <div className='flex flex-col items-stretch space-y-1 rounded-2xl border p-3 md:flex-row md:items-center md:justify-end md:space-x-2 md:space-y-0'>
        <input
          type='text'
        ...
        <button
          ...
          className='btn-primary btn tooltip tooltip-bottom'
